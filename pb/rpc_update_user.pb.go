...
// Create user request for the RPC
...
// Create user response for the RPC
...
const file_rpc_update_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04userB!Z\x1fgithub.com/chuuch/go-banking/pbb\x06proto3"
